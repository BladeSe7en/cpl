...
const Faq = () => {
    return (
        <div>
                ...
                <div className='banner-opacity-faq'>
                    <div className='faq-content'>
                        ...
                        <ul>
                            ...
                            <li> Q. How does the ELO system decide if I’ve gained or lost points over all?.</li>
                            <li> Q. How are ties and subs dealt with?</li>
                            <li> Q. How are the win/loss stats determined?</li>
                            <li> Q. How are games processed within Discord? </li>
                        </ul>
                        <h3> Q. How does the ranking work?</h3>
            ...
            over the years. https://en.wikipedia.org/wiki/Elo_rating_system
                        ...
                        <h3>Q. How does the ELO system decide if I’ve gained or lost points over all?.</h3>
    ...
    screenshot above, all the + and – skill work out exactly to Zero.</p>
                        ...
                        <h3>Q. How are ties and subs dealt with?</h3>
    ...
    and rewarding players that volunteer to sub, as well as discouraging people from requesting subs.</p>
                        ...
                        <h3>Q. How are the win/loss stats determined?</h3>
    ...
    3. Each time a game is reported, these are added to your overall wins and losses.</p>
                        ...
                        <h3>Q. How are games processed within Discord?</h3>

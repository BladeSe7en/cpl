	...
	render() {
			return (
				...
				<div className='banner-opacity'>
					...
					<ul>
						<li>
						<button className='btn add-new-topic' value={newTopicActive} onClick={this.handleNewTopic} >Add New Topic!</button>
						</li>
						<li>
						...
						form onSubmit={this.submitSpeaker}>
								...
								<Field model='new-topic-body'>
									...
									<input type="text"  name="new-topic-body" value={newTopicBody} required onChange={this.handlenewTopicBody} />
								</Field>
